...
import { Sun, Moon, User, LogOut, Plus, Home, Settings } from 'lucide-react';
...
const Header = () => {
  ...
  return (
    <header className="bg-white dark:bg-gray-800 shadow-md border-b border-gray-200 dark:border-gray-700 w-full">
      <div className="px-4">
